...
public class NotListAdapter extends BaseAdapter {
    ...
    Context ctx;
    int layout;
    ArrayList<NotiDTO> list;
    LayoutInflater inf;

    public NotListAdapter(Context ctx, int layout, ArrayList<NotiDTO> list){
        this.ctx=ctx;
        this.layout=layout;
        this.list=list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView nickname=(TextView)view.findViewById(R.id.datetext);


        NotiDTO qto=list.get(i);
        qnanum.setTextColor(Color.BLACK);
        qnanum.setText(qto.getNotinum()+"");
        qnatitle.setTextColor(Color.BLACK);
        qnatitle.setText(qto.getTitle());
        nickname.setTextColor(Color.BLACK);
        nickname.setText(qto.getNotidate());
