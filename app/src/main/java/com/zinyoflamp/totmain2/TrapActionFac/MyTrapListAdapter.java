...
public class MyTrapListAdapter extends BaseAdapter{
    ...
    public MyTrapListAdapter(Context ctx, int layout, ArrayList<TrapGridViewDTO> list){
        this.ctx=ctx;
        this.layout=layout;
        this.list=list;
    ...
    public MyTrapListAdapter(ArrayList<TrapGridViewDTO> list2){
        this.list=list;
    }
